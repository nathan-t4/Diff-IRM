...
import sys
sys.path.append("../../")
from diff_scm.datasets.io import load_idx
...
class Morpho_MNIST_Dataset(Dataset):
    """ Try normal encoding instead of one-hot """
    def __init__(self, attribute_size, train: bool = True, normalize_=False, transform=None, root_dir=os.path.join(os.path.dirname(os.path.realpath(__file__)),'data')):
        ...
        images, labels, metrics_df = load_morphomnist_like(root_dir, self.train, columns)
        ...
        self.unnormalize_fn = unnormalize
        ...
        # intensity, thickness, then digits (1+1+10)
        ...
        self.parents = ["intensity", "thickness", "digit"]
